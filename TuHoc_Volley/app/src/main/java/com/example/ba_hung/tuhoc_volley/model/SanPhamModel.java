package com.example.ba_hung.tuhoc_volley.model;
...
public class SanPhamModel {
    ...
    public SanPhamModel(int id_sanpham, String ten_sanpham, int id_danhmuc, int gia_sanpham, String mota_sanpham, int sanpham_noibat, String anh_sanpham) {
